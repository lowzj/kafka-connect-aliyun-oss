...
public class TopicPartitionWriter {
    ...
    private final RecordWriterProvider<AliyunOSSSinkConnectorConfig> writerProvider;
    ...
    public TopicPartitionWriter(TopicPartition tp,
            ...
            RecordWriterProvider<AliyunOSSSinkConnectorConfig> writerProvider,
            Partitioner<FieldSchema> partitioner,
            AliyunOSSSinkConnectorConfig connectorConfig,
    ...
    TopicPartitionWriter(TopicPartition tp,
        ...
        flushSize = connectorConfig.getInt(AliyunOSSSinkConnectorConfig.FLUSH_SIZE_CONFIG);
        topicsDir = connectorConfig.getString(StorageCommonConfig.TOPICS_DIR_CONFIG);
        rotateIntervalMs = connectorConfig.getLong(AliyunOSSSinkConnectorConfig.ROTATE_INTERVAL_MS_CONFIG);
        rotateScheduleIntervalMs = connectorConfig.getLong(AliyunOSSSinkConnectorConfig.ROTATE_SCHEDULE_INTERVAL_MS_CONFIG);
        timeoutMs = connectorConfig.getLong(AliyunOSSSinkConnectorConfig.RETRY_BACKOFF_CONFIG);
        ...
        zeroPadOffsetFormat = "%0" + connectorConfig.getInt(AliyunOSSSinkConnectorConfig.FILENAME_OFFSET_ZERO_PAD_WIDTH_CONFIG)
                + "d";
